            ...
            >
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  ...
                  >Harsh</motion.span>, a Computer Science student specializing in AI & Data Science at Poornima University, J.
                </p>
                <p>
              ...
              <InfoCard icon={GraduationCap} title="Education Journey">
                <ul className="space-y-2 text-muted-foreground">
                  {["Computer Science fundamentals", "Data structures and algorithms", 
                    "Data Science and AI", "Self-taught web development"].map((journey, i) => (
                    <motion.li 
                      key={i} 
                      className="flex items-center"
                      whileHover={{ x: 5, color: "#9b87f5" }}
