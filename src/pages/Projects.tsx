  ...
  const projects = [
    {
      ...
      code: "https://github.com/Harshnaruka01/multilabel-Classification-using-CNN-on-X-rays",
      category: "ai"
    },
    {
      id: 2,
      title: "AI-ChatBot",
      description: "This project is an AI chatbot that uses Natural Language Processing (NLP) to understand user queries and provide relevant responses. It enables human-computer interaction through a conversational interface, supporting automated query handling and improving user experience.",
      ...
      code: "https://github.com/Harshnaruka01/AI-ChatBot",
      category: "ai"
    },
    {
      id: 3,
      title: "customer_churn_prediction",
      description: "This project uses machine learning to predict customer churn by analyzing user behavior and service data, helping businesses identify at-risk customers and improve retention through data-driven insights and model evaluation.",
      ...
      code: "https://github.com/Harshnaruka01/customer_churn_prediction",
      category: "ai"
    },
    {
      id: 4,
      title: "Sales-Forecasting-using-Time-Series-Analysis",
      description: "Uses time series analysis to forecast future sales trends, improving planning and business decision-making accuracy.",
      ...
      code: "https://github.com/Harshnaruka01/Sales-Forecasting-using-Time-Series-Analysis",
      category: "ai"
    },
    {
      id: 5,
      ...
      code: "https://github.com/Harshnaruka01/FReakX",
      category: "web"
    },
    {
      id: 6,
      title: "LHS",
      description: "Web-based application using React and JavaScript to manage data, user interactions, and dynamic functionalities efficiently.",
      image: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=800&q=80",
      tags: ["React", "Node", "JavaScript"],
      code: "https://github.com/Harshnaruka01/LHS",
      category: "web"
    },
